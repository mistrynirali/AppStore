...
class AppStore extends Component {
  ...
  render() {
    ...
    const activeFilteredApps = this.getFilteredApps(activeTabId, searchInput)
    ...
    return (
      <div className="app-container">
        ...
        <ul className="apps-list-container">
          {activeFilteredApps.map(eachApp => (
            <AppItem key={eachApp.appId} apps={eachApp} />
          ))}
        </ul>
      </div>
    )
